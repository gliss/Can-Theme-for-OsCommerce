...
<body>
  <div id="spiffycalendar"
       class="text"></div><!-- header //-->
    ...
    <tr>
      ...
      <td width="100%"
        ...
        <table border="0"
          ...
          <tr>
            <?php echo tep_draw_form('new_page', FILENAME_PAGE_MANAGER, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . 'action=' . $form_action.$bIDif, 'post', 'enctype="multipart/form-data"'); if ($form_action == 'update') echo tep_draw_hidden_field('pages_id', $bID); ?>
              ...
              <table border="0"
                ...
                <tr>
                  ...
                  <select name="page_type"
                          size="1">
                    <option value=
                    "1" <? if($page_type == 1) { echo 'selected="selected"'; } ?>>
                      1 - Index
                    </option>

                    <option value=
                    "2" <? if($page_type == 2) { echo 'selected="selected"'; } ?>>
                      2 - Contact Us
                    </option>

                    <option value=
                    "3" <? if($page_type == 3) { echo 'selected="selected"'; } ?>>
                      3 - Shipping
                    </option>

                    <option value=
                    "4" <? if($page_type == 4) { echo 'selected="selected"'; } ?>>
                      4 - Privacy
                    </option>

                    <option value=
                    "5" <? if($page_type == 5) { echo 'selected="selected"'; } ?>>
                      5 - Links
                    </option>

                    <option value=
                    "6" <? if($page_type == 6) { echo 'selected="selected"'; } ?>>
                      6 - Content
                    </option>

                    <option value=
                    "7" <? if($page_type == 7) { echo 'selected="selected"'; } ?>>
                      7 - Other
                    </option>

                    <option value=
                    "8" <? if($page_type == 8) { echo 'selected="selected"'; } ?>>
                      8 - Other
                    </option>

                    <option value=
                    "9" <? if($page_type == 9) { echo 'selected="selected"'; } ?>>
                      9 - Old Page
                    </option>
                  </select></td>
                </tr><?
                ...
                <tr>
                  ...
                  <td class="main">
                  <?php echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' .  tep_draw_input_field('sort_order', $sortorder, '', false); ?></td>
                </tr>
                ...
                <tr>
                  ...
                  <input type="radio"
                         value="0"
                         name=
                         "intorext_&lt;?php echo $languages[$i]['id']; ?&gt;" <?php echo $internalchecked; ?>
                         onclick='disableIt("&lt;? echo' />");'&gt;
                         <? echo TEXT_TARGET_INTERNAL; ?>
                   &nbsp;&nbsp; 
                  <? echo tep_draw_separator('pixel_trans.gif', '24', '15'); ?>
                  <input type="radio"
                         value="1"
                         name=
                         "intorext_&lt;?php echo $languages[$i]['id']; ?&gt;" <?php echo $externalchecked;?>
                         onclick='enableIt("&lt;? echo' />");'&gt;
                         <? echo TEXT_TARGET_EXTERNAL; ?>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="main">
                  <?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']).'&nbsp;'.tep_draw_input_field('externallink_'.$languages[$i]['id'], $externallink[$languages[$i]['id']], 'id='.'"externallink_'.$languages[$i]['id'].'"'. $disabledlinkbox, false); ?></td>
                </tr><?php if(empty($link_target[$languages[$i]['id']]) or $link_target[$languages[$i]['id']] == "0")  {
                ...
                <tr>
                  ...
                  <td class="main">
                  <?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']);?><input type="radio"
                         value="0"
                         name=
                         "link_target_&lt;?php echo $languages[$i]['id']; ?&gt;" <?php echo $samewindowchecked; ?> /><? echo TEXT_TARGET_SAMEWINDOW; ?>
                   <input type="radio"
                         value="1"
                         name=
                         "link_target_&lt;?php echo $languages[$i]['id']; ?&gt;" <?php echo $newwindowchecked; ?> />
                  <? echo TEXT_TARGET_NEWWINDOW; ?>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="main">
                  <?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $languages[$i]['directory'] . '/images/' . $languages[$i]['image'], $languages[$i]['name']). '&nbsp;'.tep_draw_textarea_field('pages_html_text_'.$languages[$i]['id'],'soft','50','10', $pages_html_text[$languages[$i]['id']]); ?></td>
                </tr><?
                }
                ?>
          ...
          <tr>
            <td>
              <table border="0"
                ...
                <tr>
                  <td class="main"
                      align="center"><?php echo TEXT_PAGES_PAGE_NOTE . '<br>'; ?></td>

                  <td class="main"
                      align="right"
                      valign="top"
                      nowrap="nowrap">
                      <?php echo (($form_action == 'insert') ? tep_image_submit('button_insert.gif', IMAGE_INSERT) : tep_image_submit('button_update.gif', IMAGE_UPDATE)). '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PAGE_MANAGER, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . (!empty($bID) and $bID != "" ? 'bID=' . $bID : '')) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                </tr>
                  ...
                  <td valign="top">
                    <table border="0"
                      ...
                      <tr class="dataTableHeadingRow"
                        ...
                        <?php echo TABLE_HEADING_PAGES; ?></td>

                        <td class="dataTableHeadingContent">
                        <?php echo TEXT_PAGES_TYPE; ?></td>

                        <td class="dataTableHeadingContent">
                        <?php echo TABLE_HEADING_SORT_ORDER; ?></td>
                      ...
                      <tr>
                        ...
                        <?php echo '<a href="javascript:popupImageWindow(\'' . FILENAME_POPUP_IMAGE . '?page=' . $pages['pages_id'] . '\')">' . tep_image(DIR_WS_IMAGES . 'icon_popup.gif', 'View Page') . '</a>&nbsp;' . $pages['pages_title']; ?></td>

                        <td class="dataTableContent">
                        <?php echo $pages['page_type']; ?></td>

                        <td class="dataTableContent">
                        <?php echo $pages['sort_order']; ?></td>
                        ...
                        <td colspan="5">
                          <table border="0"
                            ...
                            <tr>
                              <td class="smallText"
                                  valign="top">
                                  <?php echo $pages_split->display_count($pages_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_PAGES); ?></td>

                              <td class="smallText"
                                  align="right">
                                  <?php echo $pages_split->display_links($pages_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></td>
                            </tr>

                            <tr>
                              <td align="right"
                                  colspan="2">
                                  <?php echo '<a href="' . tep_href_link(FILENAME_PAGE_MANAGER, 'action=new') . '">' . tep_image_button('button_new_file.gif', IMAGE_NEW_PAGE) . '</a>'; ?></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
