...
@define('TEXT_SELECT_PAYMENT_METHOD', 'Select a Payment Method');
@define('TEXT_SELECT_SHIPPING_METHOD', 'Select a Shipping Method');
@define('BUTTON_TEXT_SELECT_CUST', 'Select a customer:');
@define('TEXT_OR_BY', 'or select by customer ID:');
@define('TEXT_OR_BY_ID', 'Search Customer Number:');
@define('TEXT_OR_BY_EMAIL', 'Search Email Address:');
@define('TEXT_OR_BY_NAME', 'Search Name:');
