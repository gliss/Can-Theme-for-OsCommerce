    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="contentText">
          ...
          <p align="right"><a href="<?php echo tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL');?>" class="btn btn-default btn-lg"><?php echo IMAGE_BUTTON_CONTINUE; ?></a></p>
        </div>
      </div>
      ...
      <div class="col-md-6" style="border-left: 1px dashed #ccc;">
        ...
        <div class="contentText">
          ...
          <div class="form-group">
            ...
            <?php echo tep_draw_input_field('email_address', NULL, 'class="form-control"'); ?>
          
            <label for="password"><?php echo ENTRY_PASSWORD; ?></label>
            <?php echo tep_draw_password_field('password', NULL, 'class="form-control"'); ?>
          </div>

          <p><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></p>

          <p align="right"><?php echo tep_draw_button('Sign In', 'key',  null, 'primary', null, 'btn btn-default btn-lg'); ?></p>
