...
*/
  ...
  class splitPageResults {
    ...
    function splitPageResults(&$current_page_number, $max_rows_per_page, &$sql_query, &$query_num_rows, $fixed_number_rows = null) {
      if (empty($current_page_number)) $current_page_number = 1;

      if (is_null($fixed_number_rows)) {
      ...
      //$num_pages = ceil($query_num_rows / $max_rows_per_page);
        ...
        $query_num_rows = $fixed_number_rows;
      }
...
// calculate number of pages needing links
      ...
      if ($num_pages > 1) {
        ...
        $display_links = tep_draw_form('pages', basename($PHP_SELF), '', 'get', 'id="pages"');
        ...
        $display_links .= sprintf(TEXT_RESULT_PAGE, tep_draw_pull_down_menu($page_name, $pages_array, $current_page_number, 'onchange="$( \'#pages\' ).submit();"'), $num_pages);
