...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        // abstract
        selectHighlighted: function (options, keyCode) {
            if ( keyCode == 13 ) {
                var search = $("#s2id_autogen2_search").val(),
                    url = document.location.origin + document.location.pathname + "?search=" + search;
                $("#s2id_autogen2_search").val("Search by Name, E-Mail, Order Number, Customer Number");
                $("#search_orders").select2("close");
                $( "#poller" ).find( "label" ).eq(1).click()
                return( $( this ).directLink( url ) );
            }
            ...
            this.search.on("keydown", this.bind(function (e) {
                ...
                switch (e.which) {
                    ...
                    case KEY.DOWN:
                        ...
                        return;
                    case KEY.ENTER:
                        this.selectHighlighted('', e.keyCode);
                        killEvent(e);
                        return;
                    case KEY.TAB:
                        this.selectHighlighted({noFocus: true});
