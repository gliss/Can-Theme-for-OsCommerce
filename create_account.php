...
<?php echo tep_draw_form('create_account', tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL'), 'post', 'onsubmit="return check_form(create_account);" class="form-horizontal" role="form"', true) . tep_draw_hidden_field('action', 'process'); ?>

  <div class="panel create-account panel-default">
...
?>
      ...
      <div class="form-group">
        <label for="gender" class="col-sm-3 control-label"><?php echo ENTRY_GENDER; ?></label>
        <div class="col-sm-9">
...
?>
      ...
      <div class="form-group">
        <label for="firstname" class="col-sm-3 control-label"><?php echo ENTRY_FIRST_NAME; ?></label>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        <label for="lastname" class="col-sm-3 control-label"><?php echo ENTRY_LAST_NAME; ?></label>
        <div class="col-sm-9">
...
?>
      ...
      <div class="form-group">
        <label for="dob" class="col-sm-3 control-label"><?php echo ENTRY_DATE_OF_BIRTH; ?></label>
        <div class="col-sm-9">
          <?php echo tep_draw_input_field('dob', '', 'id="dob"') . '&nbsp;' . (tep_not_null(ENTRY_DATE_OF_BIRTH_TEXT) ? '<span class="inputRequirement">' . ENTRY_DATE_OF_BIRTH_TEXT . '</span>': ''); ?><script type="text/javascript">$('#dob').datepicker({dateFormat: '<?php echo JQUERY_DATEPICKER_FORMAT; ?>', changeMonth: true, changeYear: true, yearRange: '-100:+0'});</script>
        </div>
      </div>
...
?>
      ...
      <div class="form-group">
        <label for="email_address" class="col-sm-3 control-label"><?php echo ENTRY_EMAIL_ADDRESS; ?></label>
        <div class="col-sm-9">
...
<div class="panel create-account panel-default">
  ...
  <div class="panel-body">
    <div class="form-group">
        <label for="street_address" class="col-sm-3 control-label"><?php echo ENTRY_STREET_ADDRESS; ?></label>
        <div class="col-sm-9">
...
?>
    ...
    <div class="form-group">
        <label for="suburb" class="col-sm-3 control-label"><?php echo ENTRY_SUBURB; ?></label>
        <div class="col-sm-9">
...
?>
    ...
    <div class="form-group">
        <label for="postcode" class="col-sm-3 control-label"><?php echo ENTRY_POST_CODE; ?></label>
        <div class="col-sm-9">
...
?>
        ...
        <div class="form-group">
            <label for="state" class="col-sm-3 control-label"><?php echo ENTRY_STATE; ?></label>
            <div class="col-sm-9">
...
<div class="panel create-account panel-default">
  ...
  <div class="panel-body">
    <div class="form-group">
        ...
        <label for="telephone" class="col-sm-3 control-label"><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
        <div class="col-sm-9">
    ...
    <div class="form-group">
        <label for="fax" class="col-sm-3 control-label"><?php echo ENTRY_FAX_NUMBER; ?></label>
        <div class="col-sm-9">
    ...
    <div class="form-group"> 
        <label for="newsletter" class="col-sm-3 control-label"><?php echo ENTRY_NEWSLETTER; ?></label>
        <div class="col-sm-9">
...
<div class="panel create-account panel-default">
  ...
  <div class="panel-body">
    <div class="form-group">
        <label for="telephone" class="col-sm-3 control-label"><?php echo ENTRY_PASSWORD; ?></label>
        <div class="col-sm-9">
    ...
    <div class="form-group">   
        <label for="telephone" class="col-sm-3 control-label"><?php echo ENTRY_PASSWORD_CONFIRMATION; ?></label>
        <div class="col-sm-9">
    ...
    <div class="buttonSet">
        <span class="buttonAction"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'person', null, 'primary', null, 'btn btn-default btn-lg'); ?></span>
    </div>
