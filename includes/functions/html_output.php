...
// The HTML image wrapper function
  function tep_image($src, $alt = '', $class = '', $width = '', $height = '', $parameters = '') {
...
// the image filename as default
    ...
    if (tep_not_null($class)) $image .= ' class="' . tep_output_string($class) . '"';
...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $class = null) {
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
      ...
      $button .= '<button id="tdb' . $button_counter . '" type="' . tep_output_string($params['type']) . '" class="'.$class.'"';
    }
    ...
    $button .= '<script type="text/javascript">$("#tdb' . $button_counter . '").button(';
